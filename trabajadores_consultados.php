<?php
    ...
    $filtrartrab = mysqli_query($conn,"SELECT * FROM trabajadores WHERE cedula like '%$cedulafiltro%' AND Nombre like '%$nombretrabfiltro%' AND Apellido like '%$apellidotrabfiltro%' AND Puesto_trabajo like '%$trabfiltro%' AND Estado like '$estadofiltro%'");
                ...
                <?php
                    foreach($filtrartrab as $rowft){ ?>
                        <tr>
                            ...
                            <td><a href="partials/cambiar_estado.php?cedula=<?php echo $rowft['cedula']?>"><?php echo $rowft['Estado'];?></a></td>
                            <td><a href="./modificar_trabajador.php?cedula=<?php echo $rowft['cedula']?>">Modificar</a></td>
                        </tr>
                <?php    
                    }
                ?>
